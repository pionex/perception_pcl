...
pcl_utils::NormalsVisualizer::NormalsVisualizer(const rclcpp::NodeOptions &options)
{
  ...
  sync_clouds_a_->registerCallback(std::bind(&NormalsVisualizer::NewCloudsCallback,
                                             ...
                                             std::placeholders::_1,
                                             std::placeholders::_2));
  //this->subscription_ = node_->create_subscription<sensor_msgs::msg::PointCloud2>("normal_cloud_input", 10, std::bind(&NormalsVisualizer::NormalCloudCallback, this, std::placeholders::_1));
